...
export const smallMaxWidth = 'max-w-[940px] mx-auto md:px-8 sm:px-6 px-4 xl:px-0 min-h-[12rem]';
...
export const sideBarHeading = 'xs:mb-[6px] mb-1 font-nunito font-bold  text-[15.75px] dark:text-gray-50 text-[#333]';
