...
export const SkelatonLoader: FC<SkelatonLoaderProps> = memo(({ className, isMoviesSliderLoader = true }) => {
	...
	const arrSize = isMoviesSliderLoader ? Math.floor(window.innerWidth / 170) + 1 : 10;
